...
const expectedValidFixtureCount = 68
...
func expectedValidFixtureCases() []fixtureExpectation {
	base := []fixtureExpectation{
		...
		{name: "event-revoked", file: "event-revoked.json", schemaPointers: []string{"event.schema.json#/allOf/0/then/properties/data", "definitions.schema.json#/$defs/revocationEvent"}, instanceValues: map[string]any{"/message_type": "event", "/payload/event_type": "revoked", "/payload/data/kind": "revoked"}},
		...
		{name: "negotiation-accept-coordinator", file: "negotiation-accept.json", schemaPointers: []string{"negotiation.schema.json#/oneOf/1", "definitions.schema.json#/$defs/capabilityGrants"}, instanceValues: map[string]any{"/message_type": "negotiation", "/payload/phase": "accept", "/payload/role": "coordinator", "/payload/accepted_version": "1.0.0"}},

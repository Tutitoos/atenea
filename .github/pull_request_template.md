...
<!-- Identify plan points and distinguish local, provider-real, and client-real evidence. -->

## Validation

- [ ] Relevant automated checks pass
- [ ] Required manual or real-client validation is recorded

<!-- List exact commands and results. Mark anything not run with its reason. -->

## Risks and rollback

<!-- State material risks, compatibility limits, and a concrete rollback path. -->
...
- [ ] Breaking changes and unsupported evidence are explicit

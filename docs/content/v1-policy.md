...
| Cobertura de tests | CI exige un objetivo duro del 80,0% de cobertura global y un suelo de regresión del 77,0% en el resto de la matriz; una caída de más de un punto respecto al último `main` verde también falla | `.github/workflows/ci.yml`, `scripts/coverage-check.sh`, `scripts/coverage-history-check.sh` | El umbral es una barrera de regresión, no una prueba de cobertura semántica total |

...
`version` prints `0.8.0+1fc7977` rather than the bare number quoted on these
pages — and `0.8.0+1fc7977.modified` when the tree has uncommitted changes.
...
```text
atenea 0.8.0  contract 2.1.0  AMBER

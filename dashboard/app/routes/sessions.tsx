...
export default function SessionsRoute() {
  ...
  const result = useInfiniteQuery({ queryKey: keys.sessions(filters), initialPageParam: "", queryFn: ({ pageParam }) => api.sessions({ ...filters, cursor: pageParam || undefined }), getNextPageParam: (last) => last.next_cursor || undefined });

...
func TestIntentIsClassifiedOnWholeWordsNotSubstrings(t *testing.T) {
	for text, want := range map[string]Kind{
		...
		"Explain what failed, then implement the fix.":             KindChange,
		"Please explain the issue, and then fix it.":               KindChange,
		"Explica la causa y luego corrige el error.":               KindChange,
		"Search the code, then explain how to fix it.":             KindPlan,
